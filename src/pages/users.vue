  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Rovco Policy Agreement</h1>
        <p class="csp-updated">Last updated: July 14, 2026</p>
      </header>

      <p class="csp-intro">
        Rovco adheres to a zero-tolerance policy for any form of child
        ...
        violate the Rovco Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Rovco.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Rovco uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Rovco.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Rovco will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Rovco may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Rovco educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Rovco, we
      ...
      <section class="csp-section">
        ...
        <p>
          Rovco is committed to continuously evaluating and improving its
