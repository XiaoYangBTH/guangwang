<template>
  <div class="csp-wrapper">
    <div class="csp-container">
      ...
      <p class="csp-intro">
        Casaw adheres to a zero-tolerance policy for any form of child
        ...
        violate the Casaw Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Casaw.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Casaw uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Casaw.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Casaw will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Casaw may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Casaw educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Casaw, we
      ...
      <section class="csp-section">
        ...
        <p>
          Casaw is committed to continuously evaluating and improving its
