  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>HeyKo Policy Agreement</h1>
        <p class="csp-updated">Last updated: July 27, 2026</p>
      </header>

      <p class="csp-intro">
        HeyKo adheres to a zero-tolerance policy for any form of child
        ...
        violate the HeyKo Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use HeyKo.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          HeyKo uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using HeyKo.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          HeyKo will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, HeyKo may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>HeyKo educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of HeyKo, we
      ...
      <section class="csp-section">
        ...
        <p>
          HeyKo is committed to continuously evaluating and improving its
