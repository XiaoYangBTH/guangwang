...
<template>
  <div class="csp-wrapper">
    <div class="csp-container" :lang="currentLang">
      <div class="csp-language-switch" aria-label="Language selector">
        <span class="csp-language-label">{{ currentLang === 'en' ? 'Language' : '언어' }}</span>
        <div class="csp-language-options">
          <button
            v-for="option in languageOptions"
            :key="option.value"
            class="csp-language-button"
            :class="{ 'is-active': currentLang === option.value }"
            type="button"
            :aria-pressed="currentLang === option.value"
            @click="currentLang = option.value"
          >
            {{ option.label }}
          </button>
        </div>
      ...
      <div v-else>
        ...
        <p class="csp-intro">
          누오멧은 모든 형태의 아동 학대, 착취 및/또는 성적 행위에 대해 무관용 정책을 준수합니다. 당사는 미성년 사용자의 안전을 보호하고 플랫폼이 부적절한 행위에 사용되지 않도록 보장하기 위해 최선을 다합니다. 누오멧 정책을 위반하는 사용자는 계정이 삭제되며 법적 처벌을 받을 수 있습니다.
        </p>
        ...
        <section class="csp-section">
          <h2>1. 연령 제한</h2>
          <ul>
            <li>누오멧을 이용하려면 사용자는 만 18세 이상이어야 합니다.</li>
            <li>
              플랫폼에 접근하기 위해 나이를 허위로 표시하는 행위는 엄격히 금지되며 계정 정지 또는 삭제로 이어질 수 있습니다.
            </li>
          </ul>
        </section>
        ...
        <section class="csp-section">
          <h2>2. 금지 행위</h2>
          <p>
            누오멧은 자동화 시스템과 수동 시스템을 모두 사용하여 미성년자 활동과 아동 성적 학대 및 착취(CSAE)를 탐지합니다. 이러한 시스템을 우회하려는 모든 시도는 엄격히 금지됩니다. 금지 행위에는 다음이 포함되며 이에 국한되지 않습니다.
          </p>

          <h3>미성년자의 성적 대상화 및 아동 성적 학대와 착취(CSAE)</h3>
          <ul>
            <li>
              아동 성적 학대 또는 착취와 관련된 콘텐츠를 공유, 제작 또는 배포하는 행위.
            </li>
            <li>
              토론, 성적 행위 또는 성적으로 암시적인 의복 착용 등 미성년자에 대한 성적 관심과 관련된 모든 콘텐츠.
            </li>
            <li>
              그림이나 애니메이션과 같은 예술적 표현을 포함하여 아동 노출 또는 성적으로 암시적인 묘사에 해당하는 모든 형태의 콘텐츠.
            </li>
          </ul>

          <h3>미성년자와 관련된 유해하거나 위험한 행위</h3>
          <ul>
            <li>
              미성년자에 대한 신체적 폭력을 위협, 조장 또는 실행하는 행위.
            </li>
            <li>미성년자에 대한 심리적 학대, 강압 또는 조작.</li>
            <li>
              미성년자가 위험한 활동에 참여하도록 묘사하거나 조장하는 행위.
            </li>
            <li>미성년자에 대한 방임 또는 인신매매를 홍보하거나 묘사하는 행위.</li>
          </ul>
        </section>

        <!-- 3. Minor Representation on the Platform -->
        <section class="csp-section">
          <h2>3. 플랫폼 내 미성년자 표시</h2>
          <ul>
            <li>
              미성년자는 라이브 스트림, 동영상 또는 기타 모든 형태의 콘텐츠에 등장하는 것이 엄격히 금지됩니다.
            </li>
            <li>미성년자를 위한 계정을 만들거나 관리하는 행위는 금지됩니다.</li>
            <li>플랫폼에 접근하기 위해 나이를 허위로 표시하는 행위는 금지됩니다.</li>
          </ul>
        </section>
        ...
        <section class="csp-section">
          <h2>4. 신고 절차</h2>
          <p>
            아동 학대 사건은 적용 법률에서 요구하는 바에 따라 미국 실종·착취아동센터(NCMEC) 또는 기타 관련 기관에 신고됩니다. 사용자는 앱 내 신고 기능 또는 이메일을 통해 잠재적 위반 사항을 신고할 수 있습니다.
          </p>
        </section>
        ...
        <section class="csp-section">
          <h2>5. 금지 사용자</h2>
          <p>
            성폭행, 신체적 학대, 방임 또는 인신매매를 포함하되 이에 국한되지 않는 아동 관련 범죄로 유죄 판결을 받은 사용자는 누오멧 사용이 엄격히 금지됩니다.
          </p>
        </section>
        ...
        <section class="csp-section">
          <h2>6. 집행 및 투명성</h2>
          <p>
            누오멧은 아동 안전 정책을 엄격히 집행하며, 모든 위반은 즉각적인 제재로 이어집니다. 위반의 심각성에 따라 누오멧은 조사를 수행하기 위해 법 집행 기관과 협력할 수 있습니다.
          </p>
        </section>
        ...
        <section class="csp-section">
          <h2>7. 사용자 교육</h2>
          <p>누오멧은 다음과 같은 방법을 통해 사용자에게 아동 안전에 대해 교육합니다.</p>
          <ul>
            <li>플랫폼의 아동 안전 정책을 제공합니다.</li>
            <li>
              콘텐츠 생성 및 공유 중 잠재적 위험을 피할 수 있도록 알림과 경고를 제공합니다.
            </li>
          </ul>
        </section>
        ...
        <section class="csp-section">
          <h2>8. 추가 자료</h2>
          <p>
            누오멧 외부에서 아동 착취 또는 학대를 발견한 경우, 귀하의 위치에 따라 다음 자료에 연락할 것을 권장합니다.
          </p>
          <ul>
            <li>
              <strong>북미, 호주, 뉴질랜드:</strong> 미국 실종·착취아동센터(NCMEC)
            </li>
            <li>
              <strong>유럽:</strong> 아동 성적 강요 및 갈취에 대한 법 집행 신고 채널
            </li>
            <li>
              <strong>남미 및 기타 지역:</strong> 국제 실종·착취아동센터
            </li>
          </ul>
        </section>
        ...
        <!-- 9. Commitment to Child Safety -->
        <section class="csp-section">
          <h2>9. 아동 안전에 대한 약속</h2>
          <p>
            누오멧은 플랫폼에서 최고 수준의 아동 안전 기준을 보장하기 위해 정책, 시스템 및 관행을 지속적으로 평가하고 개선하는 데 전념합니다. 당사의 목표는 모두에게 안전하고 포용적인 공간을 제공하는 것입니다.
          </p>
        </section>
      </div>
    </div>
    ...
    <div class="csp-floating-bar">
      <span class="csp-floating-label">{{ currentLang === 'en' ? 'Contact:' : '연락처:' }}</span>
      <a class="csp-floating-email">Nuomet098772@gmail.com</a>
    </div>
  </div>
</template>
