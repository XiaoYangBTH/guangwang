  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Test1 Policy Agreement</h1>
        <p class="csp-updated">Last updated: June 25, 2025</p>
      </header>

      <p class="csp-intro">
        Test1 adheres to a zero-tolerance policy for any form of child
        ...
        violate the Test1 Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Test1.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Test1 uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Test1.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Test1 will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Test1 may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Test1 educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Test1, we
      ...
      <section class="csp-section">
        ...
        <p>
          Test1 is committed to continuously evaluating and improving its
