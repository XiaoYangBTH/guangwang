<template>
  <div class="csp-wrapper">
    <div class="csp-container">
      ...
      <p class="csp-intro">
        Kiara adheres to a zero-tolerance policy for any form of child
        ...
        violate the Kiara Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Kiara.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Kiara uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Kiara.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Kiara will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Kiara may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Kiara educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Kiara, we
      ...
      <section class="csp-section">
        ...
        <p>
          Kiara is committed to continuously evaluating and improving its
